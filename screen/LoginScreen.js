      ...
      <ScrollView>
        <View style={styles.mainConatiner}>
          <View style={styles.imageContainer}>
            <Image
              source={require('../src/assets/images/spotify_image.png')}
              style={styles.image}
            />
          </View>
          ...
          <View style={styles.btnContainer}>
            <SocialButton mode="Signup" onPress={navigateSignupScreen}>
              Sign up free
            </SocialButton>
            <SocialButton image={images.Google} onPress={handleLogin}>
              Continue with Google
            </SocialButton>
            <SocialButton image={images.facebook}>
              Continue with facebook
            </SocialButton>
            <SocialButton image={images.ios}>Continue with Apple</SocialButton>
            <SocialButton mode="Login" onPress={handleLogin}>
              Login
            </SocialButton>
          </View>
        </View>
